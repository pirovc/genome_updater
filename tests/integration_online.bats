...
@test "NA URL" {
    ...
    label="test"
    run ./genome_updater.sh -b ${label} -o ${outdir} -t ${threads} -e ${sim_files_dir}/assembly_summary_na_url.txt
    sanity_check ${outdir} ${label}
}
...
@test "All invalid URLs" {
    ...
    label="test"
    run ./genome_updater.sh -b ${label} -o ${outdir} -t ${threads} -e ${sim_files_dir}/assembly_summary_all_invalid_url.txt
    assert_success
...
@test "Some invalid URLs" {
    ...
    label="test"
    run ./genome_updater.sh -b ${label} -o ${outdir} -t ${threads} -e ${sim_files_dir}/assembly_summary_some_invalid_url.txt
    assert_success
...
@test "Conditional exit" {
    ...
    run ./genome_updater.sh -n 0 -R 1 -o ${outdir}${label}/ -t ${threads} -e ${sim_files_dir}/assembly_summary_some_invalid_url.txt
    assert_success

    label="n1"
    run ./genome_updater.sh -n 1 -R 1 -o ${outdir}${label}/ -t ${threads} -e ${sim_files_dir}/assembly_summary_some_invalid_url.txt
    assert_failure

    label="n2"
    run ./genome_updater.sh -n 2 -R 1 -o ${outdir}${label}/ -t ${threads} -e ${sim_files_dir}/assembly_summary_some_invalid_url.txt
    assert_failure

    label="n3"
    run ./genome_updater.sh -n 3 -R 1 -o ${outdir}${label}/ -t ${threads} -e ${sim_files_dir}/assembly_summary_some_invalid_url.txt
    assert_success

    label="n0.2"
    run ./genome_updater.sh -n 0.2 -R 1 -o ${outdir}${label}/ -t ${threads} -e ${sim_files_dir}/assembly_summary_some_invalid_url.txt
    assert_failure

    label="n0.5"
    run ./genome_updater.sh -n 0.5 -R 1 -o ${outdir}${label}/ -t ${threads} -e ${sim_files_dir}/assembly_summary_some_invalid_url.txt
    assert_failure

    label="n0.51"
    run ./genome_updater.sh -n 0.51 -R 1 -o ${outdir}${label}/ -t ${threads} -e ${sim_files_dir}/assembly_summary_some_invalid_url.txt
    assert_success

    label="n0.99"
    run ./genome_updater.sh -n 0.99 -R 1 -o ${outdir}${label}/ -t ${threads} -e ${sim_files_dir}/assembly_summary_some_invalid_url.txt
    assert_success
...
@test "GTDB assemblies" {
    ...
    run ./genome_updater.sh -e ${sim_files_dir}/assembly_summary_gtdb.txt -b ${label} -o ${outdir} -t ${threads} -M gtdb
    sanity_check ${outdir} ${label}
