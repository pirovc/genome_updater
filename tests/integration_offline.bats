...
@test "Invalid assembly_summary.txt" {
    ...
    label="invalid1"
    run ./genome_updater.sh -d refseq -o ${outdir} -b ${label} -e ${files_dir}simulated/assembly_summary_invalid1.txt
    assert_failure
    label="invalid2"
    run ./genome_updater.sh -d refseq -o ${outdir} -b ${label} -e ${files_dir}simulated/assembly_summary_invalid2.txt
    assert_failure
    label="invalid3"
    run ./genome_updater.sh -d refseq -o ${outdir} -b ${label} -e ${files_dir}simulated/assembly_summary_invalid3.txt
    assert_failure
    label="invalid4"
    run ./genome_updater.sh -d refseq -o ${outdir} -b ${label} -e ${files_dir}simulated/assembly_summary_invalid4.txt
    assert_failure
