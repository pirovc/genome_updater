...
@test "Database -d genbank" {
    ...
    label="genbank"
    run ./genome_updater.sh -N -d genbank -b ${label} -o ${outdir}
    sanity_check ${outdir} ${label}
    assert [ $(count_files ${outdir} ${label}) -gt 0 ] # contains files
    for file in $(ls_files ${outdir} ${label}); do
...
@test "Database -d refseq,genbank" {
    ...
    run ./genome_updater.sh -N -d refseq,genbank -b ${label} -o ${outdir}
    sanity_check ${outdir} ${label}
...
@test "Organism group -g fungi" {
    ...
    label="test"
    run ./genome_updater.sh -N -d refseq -g fungi -b ${label} -o ${outdir}
    sanity_check ${outdir} ${label}
    assert [ $(count_files ${outdir} ${label}) -gt 0 ] # contains files
}
...
@test "Taxids leaves ncbi" {
    ...
    # Use third
    run ./genome_updater.sh -N -d refseq -T "${txids[2]}" -b ${label} -o ${outdir}
    sanity_check ${outdir} ${label}
...
@test "Taxids leaves gtdb" {
    ...
    label="test"
    # Use fixed one
    run ./genome_updater.sh -N -d refseq,genbank -T 's__MWBV01 sp002069705' -b ${label} -o ${outdir} -g archaea -M gtdb
    sanity_check ${outdir} ${label}
...
@test "Refseq category" {
    ...
    # Use first
    run ./genome_updater.sh -N -d refseq -c "${rscat[0]}" -b ${label} -o ${outdir}
    sanity_check ${outdir} ${label}
...
@test "Assembly level" {
    ...
    # Use first
    run ./genome_updater.sh -N -d refseq -l "${aslev[0]}" -b ${label} -o ${outdir}
    sanity_check ${outdir} ${label}
...
@test "Custom filter" {
    ...
    run ./genome_updater.sh -N -d refseq -F "5:${rscat[0]}|12:${aslev[0]}" -b ${label} -o ${outdir}
    sanity_check ${outdir} ${label}
...
@test "Top 1 leaves ncbi" {
    ...
    run ./genome_updater.sh -N -d refseq,genbank -A 1 -b ${label} -o ${outdir}
    sanity_check ${outdir} ${label}
...
@test "Top 1 species ncbi" {
    ...
    label="test"
    # Keep only top 1 for selected species
    run ./genome_updater.sh -N -d refseq,genbank -A species:1 -b ${label} -o ${outdir}
    sanity_check ${outdir} ${label}
...
@test "Top 1 superkingdom ncbi" {
    ...
    run ./genome_updater.sh -N -d refseq -g archaea,fungi -A superkingdom:1 -b ${label} -o ${outdir}
    sanity_check ${outdir} ${label}
...
@test "Top gtdb" {
    ...
    label_none="none"
    # no top
    run ./genome_updater.sh -N -M gtdb -d refseq,genbank -g archaea -b ${label_none} -o ${outdir}
    sanity_check ${outdir} ${label_none}

    # Keep only top 1 for species
    label_species="top-species"
    run ./genome_updater.sh -N -M gtdb -d refseq,genbank -g archaea -A species:1 -b ${label_species} -o ${outdir}
    ...
    run ./genome_updater.sh -N -M gtdb -d refseq,genbank -g archaea -A genus:1 -b ${label_genus} -o ${outdir}
    ...
    run ./genome_updater.sh -N -M gtdb -d refseq,genbank -g archaea -A phylum:1 -b ${label_phylum} -o ${outdir}
...
@test "Top assemblies order" {
    ...
    run ./genome_updater.sh -N -d refseq -g archaea -c "${rscat}" -A superkingdom:1 -b ${label} -o ${outdir}    
    sanity_check ${outdir} ${label}
    ...
    run ./genome_updater.sh -N -d refseq -g archaea -l "${aslvl}" -A superkingdom:1 -b ${label} -o ${outdir}    
    sanity_check ${outdir} ${label}
...
@test "Date start filter" {
    ...
    run ./genome_updater.sh -N -d refseq -b ${label} -o ${outdir} -D ${dates[0]}
    sanity_check ${outdir} ${label}
    ...
    run ./genome_updater.sh -N -d refseq -b ${label} -o ${outdir} -D ${dates[1]}
    sanity_check ${outdir} ${label}
...
@test "Date end filter" {
    ...
    run ./genome_updater.sh -N -d refseq -b ${label} -o ${outdir} -E ${dates[-1]}
    sanity_check ${outdir} ${label}
    assert_equal $(count_lines_file "${local_dir}genomes/refseq/assembly_summary_refseq.txt") $(count_lines_file ${outdir}assembly_summary.txt)

    label="test_some"
    # Use second last date as end, should return less than everything
    run ./genome_updater.sh -N -d refseq -b ${label} -o ${outdir} -E ${dates[-2]}
    sanity_check ${outdir} ${label}
    assert [ $(count_lines_file "${local_dir}genomes/refseq/assembly_summary_refseq.txt") -gt $(count_lines_file ${outdir}assembly_summary.txt) ]
}
...
@test "Date start-end filter" {
    ...
    run ./genome_updater.sh -N -d refseq -b ${label} -o ${outdir} -D ${dates[0]} -E ${dates[-1]}
    sanity_check ${outdir} ${label}
    assert_equal $(count_lines_file "${local_dir}genomes/refseq/assembly_summary_refseq.txt") $(count_lines_file ${outdir}assembly_summary.txt)

    label="test_some"
    # Use second date as start, second to last as end, should return less than everything
    run ./genome_updater.sh -N -d refseq -b ${label} -o ${outdir} -D ${dates[1]} -E ${dates[-2]}
    sanity_check ${outdir} ${label}
    assert [ $(count_lines_file "${local_dir}genomes/refseq/assembly_summary_refseq.txt") -gt $(count_lines_file ${outdir}assembly_summary.txt) ]
}
...
@test "Report assembly accession" {
    ...
    label="test"
    run ./genome_updater.sh -N -d refseq -b ${label} -o ${outdir} -u
    sanity_check ${outdir} ${label}
...
@test "Report urls" {
    ...
    label="test"
    run ./genome_updater.sh -N -d refseq -b ${label} -o ${outdir} -p
    sanity_check ${outdir} ${label}
...
@test "External assembly summary" {
    ...
    run ./genome_updater.sh -N -b ${label} -o ${outdir} -e ${local_dir}genomes/refseq/assembly_summary_refseq.txt
    sanity_check ${outdir} ${label}
}
...
@test "Rollback label" {
    ...
    label1="v1"
    run ./genome_updater.sh -N -d refseq -b ${label1} -o ${outdir} -d refseq
    sanity_check ${outdir} ${label1}

    # Second version with more entries (refseq,genbank)
    label2="v2"
    run ./genome_updater.sh -N -b ${label2} -o ${outdir} -d refseq,genbank
    sanity_check ${outdir} ${label2}

    # Third version with same entries (nothing to download)
    label3="v3"
    run ./genome_updater.sh -N -b ${label3} -o ${outdir} -d refseq,genbank
    ...
    label4="v4"
    run ./genome_updater.sh -N -b ${label4} -o ${outdir} -d refseq,genbank -B v1
...
@test "Rollback label auto update" {
    ...
    # Base version with only refseq
    label1="v1"
    run ./genome_updater.sh -N -d refseq -b ${label1} -o ${outdir}
    sanity_check ${outdir} ${label1}
    ...
    # Third version with same entries (nothing to download)
    label3="v3"
    run ./genome_updater.sh -N -b ${label3} -o ${outdir}
    sanity_check ${outdir} ${label3}
    ...
    label4="v4"
    run ./genome_updater.sh -N -b ${label4} -o ${outdir} -B v1 -d refseq,genbank
    sanity_check ${outdir} ${label4}
    ...
    label5="v5"
    run ./genome_updater.sh -N -b ${label5} -o ${outdir} -B ""
...
@test "Delete extra files" {
    ...
    run ./genome_updater.sh -N -d refseq -b ${label} -o ${outdir} -i -x
    sanity_check ${outdir} ${label}
    # File was removed
...
@test "Threads" {
    ...
    label="test"
    run ./genome_updater.sh -N -d refseq -b ${label} -o ${outdir} -t 8
    sanity_check ${outdir} ${label}
}
...
@test "Silent" {
    ...
    label="test"
    run ./genome_updater.sh -N -d refseq -b ${label} -o ${outdir} -s
    sanity_check ${outdir} ${label}
...
@test "Mode FIX" {
    ...
    # Dry-run FIX
    run ./genome_updater.sh -N -d refseq -b ${label} -o ${outdir} -k -i
    assert_success
    assert_file_empty {outdir}${label}/files/

    # Real run FIX
    run ./genome_updater.sh -N -d refseq -b ${label} -o ${outdir} -i
    sanity_check ${outdir} ${label}
}
...
@test "Tax. Mode GTDB" {
    ...
    label="test"
    run ./genome_updater.sh -N -d refseq,genbank -g archaea -b ${label} -o ${outdir} -M gtdb
    sanity_check ${outdir} ${label}
...
@test "Invalid assembly_summary.txt" {
    ...
    label="cols"
    run ./genome_updater.sh -N -o ${outdir} -b ${label} -e ${files_dir}simulated/assembly_summary_invalid_cols.txt
    assert_failure
    label="headermiddle"
    run ./genome_updater.sh -N -o ${outdir} -b ${label} -e ${files_dir}simulated/assembly_summary_invalid_headermiddle.txt
    assert_failure
    label="justheader"
    run ./genome_updater.sh -N -o ${outdir} -b ${label} -e ${files_dir}simulated/assembly_summary_invalid_justheader.txt
    assert_failure
    label="xCF"
    run ./genome_updater.sh -N -o ${outdir} -b ${label} -e ${files_dir}simulated/assembly_summary_invalid_xCF.txt
    assert_failure
}
